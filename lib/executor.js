    ...
    login() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                keytar_1.default.setPassword("PreFlight", "AccessToken", response.access_token);
            }
            catch (err) {
                throw err;
            }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (request.clientId && request.clientSecret) {
                    ...
                    accessToken = (_a = yield keytar_1.default.getPassword("PreFlight", "AccessToken")) !== null && _a !== void 0 ? _a : "";
                }
                if (!accessToken) {
